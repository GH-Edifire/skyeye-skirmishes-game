...
public class RangedInfantry extends Group {
    private final double ATTACK_COOLDOWN = 1.0;
    private final double RELOAD_COOLDOWN = 3.0;
    ...
    private Bullet bulletOne, bulletTwo, bulletThree;
    private double distance;
    private float volume = 0.25f;
    private Sound rangedSoundOne;
    private Sound rangedSoundTwo;
    private Sound rangedSoundThree;
    private Sound rangedSoundFour;
    ...
    public RangedInfantry(Sprite newSprite, int owner) {
        this.setName("R");
        sprite = newSprite;
        this.owner = owner;
...
//        setOrigin(0f, 0f);
        ...
        rangedSoundOne = Gdx.audio.newSound(Gdx.files.internal("sound/battle_musket_01.wav"));
        rangedSoundTwo = Gdx.audio.newSound(Gdx.files.internal("sound/battle_musket_02.wav"));
        rangedSoundThree = Gdx.audio.newSound(Gdx.files.internal("sound/battle_musket_03.wav"));
        rangedSoundFour = Gdx.audio.newSound(Gdx.files.internal("sound/battle_musket_04.wav"));
...
//        this.addActor(bulletThree);
    ...
    public void setBullets(Bullet bulletOne, Bullet bulletTwo, Bullet bulletThree){
    ...
    public void colorUnit(Color color) {
        ...
        RangedInfantry.this.addAction(colorAction);
    }
    ...
    public void moveUnit(int x, int y) {
        ...
        if(canMove){
            RangedInfantry.this.addAction(moveToAction);
        }
    }
    ...
    public void attackUnit(Actor player, Actor enemy) {
        ...
        if (!collision && ableToFire && distance < 400){
            switch(random){
                case 0:
                {
                ...
                case 2:
                {
                    rangedSoundThree.play(volume);
                    break;
                }
                case 3:
                {
                    rangedSoundFour.play(volume);
                    break;
                }
                default:
                {
            ...
            setFollowing(false);
            setAttacking(true);
            bulletOne.setPosition(getX()+0*this.getWidth()/5,getY()+this.getHeight()/2);
            bulletTwo.setPosition(getX()+2*this.getWidth()/5,getY()+this.getHeight()/2);
            bulletThree.setPosition(getX()+4*this.getWidth()/5,getY()+this.getHeight()/2);
            bulletOne.setVisible(true);
            bulletTwo.setVisible(true);
            bulletThree.setVisible(true);
            bulletOne.moveUnit((int) (enemy.getX()+0*enemy.getWidth()/5),(int) (enemy.getY()+enemy.getHeight()/2), enemy);
            bulletTwo.moveUnit((int) (enemy.getX()+2*enemy.getWidth()/5),(int) (enemy.getY()+enemy.getHeight()/2), enemy);
            bulletThree.moveUnit((int) (enemy.getX()+4*enemy.getWidth()/5),(int) (enemy.getY()+enemy.getHeight()/2), enemy);
        }
