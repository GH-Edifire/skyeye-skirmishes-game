...
public class Infantry extends Group {
    ...
    public Infantry(Sprite newSprite) {
        this.setName("I");
        sprite = newSprite;
    ...
    public void colorUnit(Color color) {
        ...
        Infantry.this.addAction(colorAction);
    }
    ...
    public void moveUnit(int x, int y) {
        ...
        Infantry.this.addAction(moveToAction);
    }

    private Timer timer = new Timer();

    //TODO need cases for each unit type
